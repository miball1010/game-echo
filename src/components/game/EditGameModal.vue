...
<template>
    <transition name="fadeup">
        <div v-if="modalIsOpen"
            class="bg-black/20 w-full h-screen fixed top-0 left-0 flex justify-center items-center z-20">
            <div class="relative bg-gray-200 max-w-[900px] w-[93%] max-h-[95%] rounded-sm overflow-y-scroll">
